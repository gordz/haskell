...
Choose a correct implementation of the function isChoice :: Eq a => [a] -> [a] -> Bool that decides whether one list is chosen from another. In other words, isChoice xs ys checks whether all elements in xs are present in ys. 
-------------------------------------------------
